...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .btn-red { background: linear-gradient(135deg, #FF416C 0%, #FF4B2B 100%); flex: 1; padding: 12px; color: white; border: none; border-radius: 10px; font-weight: 700; cursor: pointer; }
        .btn-secondary { background: #cbd5e1; color: #334155; flex: 1; padding: 12px; border: none; border-radius: 10px; font-weight: 700; cursor: pointer; }
    </style>
</head>
<body>
    ...
    <div class="container">
        <div class="header">
            <div>
                ...
                <p style="font-size: 13px; color: #64748b; margin-top: 4px;">Select a blood group from the central stock to request emergency units instantly.</p>
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="hospital_request_submit.php" method="POST">
                ...
                <div class="modal-actions">
                    ...
                    <button type="submit" class="btn-red">Submit Request</button>
                </div>
            </form>
        </div>
    </div>
