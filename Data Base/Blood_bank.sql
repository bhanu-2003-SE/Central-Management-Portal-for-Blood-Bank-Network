--------------------------------------------------------
--  File created - Monday-September-07-2026   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE, 
	 CONSTRAINT "AGENT_MUST_BE_CREATED" FOREIGN KEY ("AGENT_NAME")
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AQ$_KEY_SHARD_MAP" SHARING=METADATA 
   (	"QUEUE" NUMBER NOT NULL ENABLE, 
	"KEY" VARCHAR2(128) NOT NULL ENABLE, 
	"SHARD" NUMBER NOT NULL ENABLE, 
	"DELAY_SHARD" NUMBER NOT NULL ENABLE, 
	 CONSTRAINT "AQ$_KEY_SHARD_MAP_PK" UNIQUE ("QUEUE", "KEY")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BLOOD_INVENTORY" 
   (	"BLOOD_GROUP" VARCHAR2(5), 
	"TOTAL_UNITS" NUMBER DEFAULT 0, 
	"STATUS" VARCHAR2(30) DEFAULT 'Healthy Stock', 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM"
--------------------------------------------------------
--  DDL for Table BLOOD_STOCK
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."BLOOD_STOCK" 
   (	"BLOOD_GROUP" VARCHAR2(10), 
	"TOTAL_UNITS" NUMBER NOT NULL ENABLE, 
	 PRIMARY KEY ("BLOOD_GROUP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CAMPS" 
   (	"CAMP_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"CAMP_NAME" VARCHAR2(150) NOT NULL ENABLE, 
	"VENUE" VARCHAR2(200) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM"
--------------------------------------------------------
--  DDL for Table CAMP_APPOINTMENTS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CAMP_APPOINTMENTS" 
   (	"APPOINTMENT_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"CAMP_ID" NUMBER, 
	"TIME_SLOT" VARCHAR2(50) NOT NULL ENABLE, 
	"PASS_CODE" VARCHAR2(30) NOT NULL ENABLE, 
  ...
  TABLESPACE "SYSTEM"  ENABLE, 
	 FOREIGN KEY ("CAMP_ID")
	  REFERENCES "SYSTEM"."CAMPS" ("CAMP_ID") ENABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM"
--------------------------------------------------------
--  DDL for Table CAMP_BOOKINGS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CAMP_BOOKINGS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."HOSPITALS" 
   (	"HOSPITAL_ID" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"HOSPITAL_NAME" VARCHAR2(150) NOT NULL ENABLE, 
	"EMAIL" VARCHAR2(100) NOT NULL ENABLE, 
	"PHONE" VARCHAR2(20), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM"
--------------------------------------------------------
--  DDL for Table HOSPITAL_REQUESTS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HOSPITAL_REQUESTS" 
   (	"REQUEST_ID" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"HOSPITAL_NAME" VARCHAR2(150) NOT NULL ENABLE, 
	"BLOOD_GROUP" VARCHAR2(10) NOT NULL ENABLE, 
	"UNITS" NUMBER(*,0) NOT NULL ENABLE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNRC_GTCS" SHARING=METADATA 
   (	"LOGMNR_UID" NUMBER NOT NULL ENABLE, 
	...
	"COLLINTCOL#" NUMBER, 
	"ACDRRESCOL#" NUMBER, 
	 CONSTRAINT "LOGMNRC_GTCS_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "OBJV#", "INTCOL#")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX"  LOCAL
  ...
  CREATE TABLE "SYSTEM"."LOGMNRC_USER" SHARING=METADATA 
   (	"LOGMNR_UID" NUMBER NOT NULL ENABLE, 
	...
	"SPARE3_C" VARCHAR2(4000), 
	 CONSTRAINT "LOGMNRC_USER_PK" PRIMARY KEY ("LOGMNR_UID", "USER#", "START_SCN")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX"  LOCAL
  ...
  CREATE GLOBAL TEMPORARY TABLE "SYSTEM"."LOGMNRT_MDDL$" SHARING=METADATA 
   (	"SOURCE_OBJ#" NUMBER, 
	...
	"DEST_ROWID" ROWID NOT NULL ENABLE, 
	 CONSTRAINT "LOGMNRT_MDDL$_PK" PRIMARY KEY ("SOURCE_OBJ#", "SOURCE_ROWID") ENABLE
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_ATTRCOL$" SHARING=METADATA 
   (	"INTCOL#" NUMBER, 
	...
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_ATTRCOL$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_ATTRIBUTE$" SHARING=METADATA 
   (	"VERSION#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_ATTRIBUTE$_PK" PRIMARY KEY ("LOGMNR_UID", "TOID", "VERSION#", "ATTRIBUTE#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_CCOL$" SHARING=METADATA 
   (	"CON#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_CCOL$_PK" PRIMARY KEY ("LOGMNR_UID", "CON#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_COL$" SHARING=METADATA 
   (	"COL#" NUMBER(22,0), 
	...
	"COLLINTCOL#" NUMBER, 
	"ACDRRESCOL#" NUMBER, 
	 CONSTRAINT "LOGMNR_COL$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_COLTYPE$" SHARING=METADATA 
   (	"COL#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_COLTYPE$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_CON$" SHARING=METADATA 
   (	"OWNER#" NUMBER NOT NULL ENABLE, 
	...
	"START_SCNBAS" NUMBER, 
	"START_SCNWRP" NUMBER, 
	 CONSTRAINT "LOGMNR_CON$_PK" PRIMARY KEY ("LOGMNR_UID", "CON#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_CONTAINER$" SHARING=METADATA 
   (	"OBJ#" NUMBER NOT NULL ENABLE, 
	...
	"FED_ROOT_CON_ID#" NUMBER, 
	 CONSTRAINT "LOGMNR_CONTAINER$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_DICTSTATE$" SHARING=METADATA 
   (	"LOGMNR_UID" NUMBER(22,0), 
	...
	"RBABYTE" NUMBER, 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_DICTSTATE$_PK" PRIMARY KEY ("LOGMNR_UID") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_ENC$" SHARING=METADATA 
   (	"OBJ#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_ENC$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "OWNER#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_ICOL$" SHARING=METADATA 
   (	"OBJ#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_ICOL$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_IDNSEQ$" SHARING=METADATA 
   (	"OBJ#" NUMBER NOT NULL ENABLE, 
	"INTCOL#" NUMBER NOT NULL ENABLE, 
	"SEQOBJ#" NUMBER NOT NULL ENABLE, 
	"STARTWITH" NUMBER NOT NULL ENABLE, 
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_IDNSEQ$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_INDCOMPART$" SHARING=METADATA 
   (	"OBJ#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_INDCOMPART$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_INDPART$" SHARING=METADATA 
   (	"OBJ#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_INDPART$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "BO#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_INDSUBPART$" SHARING=METADATA 
   (	"OBJ#" NUMBER(22,0), 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_INDSUBPART$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "POBJ#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_KOPM$" SHARING=METADATA 
   (	"LENGTH" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_KOPM$_PK" PRIMARY KEY ("LOGMNR_UID", "NAME") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_LOB$" SHARING=METADATA 
   (	"OBJ#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_LOB$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_LOBFRAG$" SHARING=METADATA 
   (	"FRAGOBJ#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_LOBFRAG$_PK" PRIMARY KEY ("LOGMNR_UID", "FRAGOBJ#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_LOGMNR_BUILDLOG" SHARING=METADATA 
   (	"BUILD_DATE" VARCHAR2(20), 
	...
	"SPARE2" VARCHAR2(4000), 
	 CONSTRAINT "LOGMNR_LOGMNR_BUILDLOG_PK" PRIMARY KEY ("LOGMNR_UID", "INITIAL_XID") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_NTAB$" SHARING=METADATA 
   (	"COL#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_NTAB$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_OPQTYPE$" SHARING=METADATA 
   (	"INTCOL#" NUMBER NOT NULL ENABLE, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_OPQTYPE$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_PARTOBJ$" SHARING=METADATA 
   (	"PARTTYPE" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_PARTOBJ$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_PROFILE_PLSQL_STATS$" SHARING=METADATA 
   (	"PKGOWNER" VARCHAR2(384), 
	...
	"SPARE5" NUMBER, 
	"SPARE6" NUMBER, 
	 CONSTRAINT "LOGMNR_PROFILE_PLSQL$_PK" PRIMARY KEY ("PKGOWNER", "PKGNAME", "NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_PROPS$" SHARING=METADATA 
   (	"VALUE$" VARCHAR2(4000), 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_PROPS$_PK" PRIMARY KEY ("LOGMNR_UID", "NAME") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_REFCON$" SHARING=METADATA 
   (	"COL#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_REFCON$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_SEED$" SHARING=METADATA 
   (	"SEED_VERSION" NUMBER(22,0), 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_SEED$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_SHARD_TS" SHARING=METADATA 
   (	"LOGMNR_UID" NUMBER NOT NULL ENABLE, 
	...
	"START_SCNBAS" NUMBER, 
	"START_SCNWRP" NUMBER, 
	 CONSTRAINT "LOGMNR_SHARD_TS_PK" PRIMARY KEY ("LOGMNR_UID", "TABLESPACE_NAME") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_SUBCOLTYPE$" SHARING=METADATA 
   (	"INTCOL#" NUMBER NOT NULL ENABLE, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_SUBCOLTYPE$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "INTCOL#", "TOID") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_TABCOMPART$" SHARING=METADATA 
   (	"OBJ#" NUMBER(22,0), 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_TABCOMPART$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_TABPART$" SHARING=METADATA 
   (	"OBJ#" NUMBER(22,0), 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_TABPART$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "BO#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_TABSUBPART$" SHARING=METADATA 
   (	"OBJ#" NUMBER(22,0), 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_TABSUBPART$_PK" PRIMARY KEY ("LOGMNR_UID", "OBJ#", "POBJ#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGMNR_TYPE$" SHARING=METADATA 
   (	"VERSION#" NUMBER, 
	...
	"LOGMNR_UID" NUMBER(22,0), 
	"LOGMNR_FLAGS" NUMBER(22,0), 
	 CONSTRAINT "LOGMNR_TYPE$_PK" PRIMARY KEY ("LOGMNR_UID", "TOID", "VERSION#") DISABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255  LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSAUX" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."MARKS" 
   (	"MID" NUMBER NOT NULL ENABLE, 
	"STUID" NUMBER NOT NULL ENABLE, 
	"MARKS" NUMBER NOT NULL ENABLE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."REDO_DB" SHARING=METADATA 
   (	"DBID" NUMBER NOT NULL ENABLE, 
	...
	"SPARE11" NUMBER, 
	"SPARE12" NUMBER, 
	"TENANT_KEY" NUMBER NOT NULL ENABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."REPL_SUPPORT_MATRIX" SHARING=METADATA 
   (	"FEATURE_NAME" VARCHAR2(100), 
	...
	"BMAP1" NUMBER, 
	"BMAP2" NUMBER, 
	"REPL_PRODUCT" NUMBER NOT NULL ENABLE, 
	"SUPPORT_MODE" NUMBER NOT NULL ENABLE, 
	"MIN_COMPAT" NUMBER, 
	"MAX_COMPAT" NUMBER, 
	 CONSTRAINT "REPL_SUPPORT_MATRIX_PK" PRIMARY KEY ("BMAP1", "BMAP2", "REPL_PRODUCT", "SUPPORT_MODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM"
--------------------------------------------------------
--  DDL for Table STAFF_ASSIGNMENTS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."STAFF_ASSIGNMENTS" 
   (	"STAFF_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"ASSIGNED_CAMP" VARCHAR2(100) NOT NULL ENABLE, 
	"SHIFT_TIME" VARCHAR2(50) NOT NULL ENABLE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."STUDENT" 
   (	"STUID" NUMBER NOT NULL ENABLE, 
	"STUNAME" VARCHAR2(20) NOT NULL ENABLE, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."STUDENT_VIEW" ("STUID", "STUNAME", "ADDRESS", "BIRTHDAY", "AGE") AS 
  SELECT stuid, stuname, address, birthday, age
FROM Student
--------------------------------------------------------
--  DDL for Materialized View STUDENT_AGE_MV
--------------------------------------------------------

  CREATE MATERIALIZED VIEW "SYSTEM"."STUDENT_AGE_MV" ("STUID", "STUNAME", "ADDRESS", "BIRTHDAY", "AGE")
 ...
 NOCOMPRESS LOGGING
  ...
  AS SELECT stuid,stuname,address,birthday,age
FROM Student

   COMMENT ON MATERIALIZED VIEW "SYSTEM"."STUDENT_AGE_MV"  IS 'snapshot table for snapshot SYSTEM.STUDENT_AGE_MV'
--------------------------------------------------------
--  DDL for Materialized View STUDENT_AVG_AGE_MV
--------------------------------------------------------

  CREATE MATERIALIZED VIEW "SYSTEM"."STUDENT_AVG_AGE_MV" ("AVG_AGE")
  SEGMENT CREATION IMMEDIATE
  ORGANIZATION HEAP PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  USING ENFORCED CONSTRAINTS DISABLE ON QUERY COMPUTATION DISABLE QUERY REWRITE
  AS SELECT AVG(age) AS avg_age
FROM Student

   COMMENT ON MATERIALIZED VIEW "SYSTEM"."STUDENT_AVG_AGE_MV"  IS 'snapshot table for snapshot SYSTEM.STUDENT_AVG_AGE_MV'
--------------------------------------------------------
--  DDL for Materialized View STUDENT_DEMAND_MV
--------------------------------------------------------

  CREATE MATERIALIZED VIEW "SYSTEM"."STUDENT_DEMAND_MV" ("STUID", "STUNAME", "ADDRESS", "BIRTHDAY", "AGE")
  SEGMENT CREATION IMMEDIATE
  ORGANIZATION HEAP PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
FROM Student
   ...
   COMMENT ON MATERIALIZED VIEW "SYSTEM"."STUDENT_DEMAND_MV"  IS 'snapshot table for snapshot SYSTEM.STUDENT_DEMAND_MV'
--------------------------------------------------------
--  DDL for Materialized View STUDENT_ID_MV
--------------------------------------------------------

  CREATE MATERIALIZED VIEW "SYSTEM"."STUDENT_ID_MV" ("STUID", "STUNAME", "ADDRESS", "BIRTHDAY", "AGE")
  SEGMENT CREATION IMMEDIATE
  ORGANIZATION HEAP PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
FROM Student
   ...
   COMMENT ON MATERIALIZED VIEW "SYSTEM"."STUDENT_ID_MV"  IS 'snapshot table for snapshot SYSTEM.STUDENT_ID_MV'
--------------------------------------------------------
--  DDL for Materialized View STUDENT_MV
--------------------------------------------------------

  CREATE MATERIALIZED VIEW "SYSTEM"."STUDENT_MV" ("STUID", "STUNAME", "ADDRESS", "BIRTHDAY", "AGE")
  SEGMENT CREATION IMMEDIATE
  ORGANIZATION HEAP PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
FROM Student
   ...
   COMMENT ON MATERIALIZED VIEW "SYSTEM"."STUDENT_MV"  IS 'snapshot table for snapshot SYSTEM.STUDENT_MV'
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.BLOOD_INVENTORY
SET DEFINE OFF;
Insert into SYSTEM.BLOOD_INVENTORY (BLOOD_GROUP,TOTAL_UNITS,STATUS) values ('O+',210,'Healthy Stock');
Insert into SYSTEM.BLOOD_INVENTORY (BLOOD_GROUP,TOTAL_UNITS,STATUS) values ('O-',2,'Critical Low');
Insert into SYSTEM.BLOOD_INVENTORY (BLOOD_GROUP,TOTAL_UNITS,STATUS) values ('A+',150,'Healthy Stock');
Insert into SYSTEM.BLOOD_INVENTORY (BLOOD_GROUP,TOTAL_UNITS,STATUS) values ('B+',120,'Healthy Stock');
REM INSERTING into SYSTEM.BLOOD_STOCK
SET DEFINE OFF;
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('O+',210);
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('O-',5);
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('A+',26);
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('A-',12);
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('B+',68);
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('B-',56);
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('AB+',578);
Insert into SYSTEM.BLOOD_STOCK (BLOOD_GROUP,TOTAL_UNITS) values ('AB-',345);
REM INSERTING into SYSTEM.CAMPS
SET DEFINE OFF;
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (30,'Colombo Central Blood Drive','Town Hall Premises, Colombo',null,null,'6.9147','79.8656','2026-09-06','2026-09-30');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (32,'Matara Youth Blood Drive','Sanath Jayasuriya Stadium Premises, Matara',null,null,'5.9485','80.5353','2026-09-30','2026-09-30');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (33,'Wayamba Blood Donation Drive','Town Hall Grounds, Kurunegala',null,null,'7.4863','80.3623','2026-09-03','2026-09-27');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (31,'Kandy Youth Blood Donation Drive','City Center Hall, Kandy',null,null,'7.2906','80.6337','2026-09-17','2026-09-24');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (34,'Peradeniya Medical Faculty Drive','University Gymnasium, Peradeniya',null,null,'7.2728','80.5944','2026-10-01','2026-10-30');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (35,'Ratnapura Public Drive','Municipal Council Hall, Ratnapura',null,null,'6.6828','80.3992','2026-09-16','2026-09-22');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (36,'Jaffna City Blood Drive','Municipal Council Auditorium, Jaffna',null,null,'9.6615','80.0255','2026-09-10','2026-09-17');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (37,'Kilinochchi Central Drive','District General Hospital Hall, Kilinochchi',null,null,'9.3803','80.3992','2026-09-01','2026-09-30');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (38,'Rajarata Community Blood Camp','Town Hall Auditorium, Anuradhapura',null,null,'8.3114','80.4037','2026-09-10','2026-09-23');
Insert into SYSTEM.CAMPS (CAMP_ID,CAMP_NAME,VENUE,START_TIME,END_TIME,LATITUDE,LONGITUDE,START_DATE,END_DATE) values (39,'Trincomalee Harbor Blood Drive','McHeyzer Stadium Premises, Trincomalee',null,null,'8.5711','81.2335','2026-10-01','2026-10-28');
REM INSERTING into SYSTEM.CAMP_APPOINTMENTS
SET DEFINE OFF;
Insert into SYSTEM.CAMP_APPOINTMENTS (APPOINTMENT_ID,DONOR_ID,CAMP_ID,TIME_SLOT,PASS_CODE,STATUS) values (44,'D-7470',35,'08:30 AM - 09:30 AM','LLC-2026-5239','Completed');
Insert into SYSTEM.CAMP_APPOINTMENTS (APPOINTMENT_ID,DONOR_ID,CAMP_ID,TIME_SLOT,PASS_CODE,STATUS) values (45,'D-7470',35,'11:30 AM - 12:30 PM','LLC-2026-5839','Completed');
Insert into SYSTEM.CAMP_APPOINTMENTS (APPOINTMENT_ID,DONOR_ID,CAMP_ID,TIME_SLOT,PASS_CODE,STATUS) values (46,'D-1568',31,'08:30 AM - 09:30 AM','LLC-2026-7121','Completed');
Insert into SYSTEM.CAMP_APPOINTMENTS (APPOINTMENT_ID,DONOR_ID,CAMP_ID,TIME_SLOT,PASS_CODE,STATUS) values (42,'D-1568',31,'11:30 AM - 12:30 PM','LLC-2026-4401','Completed');
Insert into SYSTEM.CAMP_APPOINTMENTS (APPOINTMENT_ID,DONOR_ID,CAMP_ID,TIME_SLOT,PASS_CODE,STATUS) values (43,'D-1568',31,'09:30 AM - 10:30 AM','LLC-2026-2229','Completed');
REM INSERTING into SYSTEM.CAMP_BOOKINGS
SET DEFINE OFF;
REM INSERTING into SYSTEM.DONATIONS
SET DEFINE OFF;
Insert into SYSTEM.DONATIONS (DONATION_ID,DONOR_ID,CAMP_ID,DONATION_DATE,EXPIRY_DATE,VOLUME_ML,STATUS) values ('DN-001','D-8821','C-102',to_date('10-AUG-26','DD-MON-RR'),to_date('15-SEP-26','DD-MON-RR'),450,'Completed');
REM INSERTING into SYSTEM.DONORS
SET DEFINE OFF;
Insert into SYSTEM.DONORS (DONOR_ID,FULL_NAME,NIC,DOB,GENDER,BLOOD_GROUP,WEIGHT,LAST_DONATION,HEALTH_CONDITIONS,DISTRICT,CITY,CONTACT_NO,EMERGENCY_CONTACT,EMAIL,USER_PASSWORD,CREATED_AT) values ('D-9179','amri','200721456782',to_date('03-AUG-04','DD-MON-RR'),'Male','O-',68,'MoreThan4','None','Colombo','Peta','0787877376','0784767376','amri@gamil.com','$2y$10$q8z26HGuEpHGaKhuVwa2DOHY2hRUaTwwuDs1xJffffWQyPGyvpxkq',to_timestamp('06-SEP-26 10.02.42.186000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DONORS (DONOR_ID,FULL_NAME,NIC,DOB,GENDER,BLOOD_GROUP,WEIGHT,LAST_DONATION,HEALTH_CONDITIONS,DISTRICT,CITY,CONTACT_NO,EMERGENCY_CONTACT,EMAIL,USER_PASSWORD,CREATED_AT) values ('D-1616','Ushan Sachiru','200321712162',to_date('04-AUG-03','DD-MON-RR'),'Male','O+',67,'MoreThan4','None','Galle','Gandara','0768477376','0768477376','sachiruushan@gmail.com','$2y$10$96p59OpOuZtVqr34fxMb2eP011hasbH0r5bitD0UdCoHX6rw8GLwO',to_timestamp('06-SEP-26 09.36.45.232000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DONORS (DONOR_ID,FULL_NAME,NIC,DOB,GENDER,BLOOD_GROUP,WEIGHT,LAST_DONATION,HEALTH_CONDITIONS,DISTRICT,CITY,CONTACT_NO,EMERGENCY_CONTACT,EMAIL,USER_PASSWORD,CREATED_AT) values ('D-1471','Gayaru  Anuchamath','200821712162',to_date('26-DEC-07','DD-MON-RR'),'Male','B+',85,'MoreThan4','None','Galle','Kirinda','0768477376','0768477376','gayarunthaka@gmail.com','$2y$10$v0JA7fDC0ZsuWrzQ2K/pdejhrjCtMdvEFfrcEtXoGPUuTgb.xvnjy',to_timestamp('06-SEP-26 11.52.22.884000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DONORS (DONOR_ID,FULL_NAME,NIC,DOB,GENDER,BLOOD_GROUP,WEIGHT,LAST_DONATION,HEALTH_CONDITIONS,DISTRICT,CITY,CONTACT_NO,EMERGENCY_CONTACT,EMAIL,USER_PASSWORD,CREATED_AT) values ('D-1568','lamidu tashan','200424563217',to_date('03-SEP-04','DD-MON-RR'),'Male','O-',57,'Never','None','Kandy','Peradeniya','0741724894','bhanuka-0768477376','lamidutashan500@gmail.com','$2y$10$.ptIYKb7fjpdKpU6/2Hw2uHIckp5iLeMFStcBrK9RIQsydEWT12Ry',to_timestamp('06-SEP-26 01.25.05.636000000 PM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DONORS (DONOR_ID,FULL_NAME,NIC,DOB,GENDER,BLOOD_GROUP,WEIGHT,LAST_DONATION,HEALTH_CONDITIONS,DISTRICT,CITY,CONTACT_NO,EMERGENCY_CONTACT,EMAIL,USER_PASSWORD,CREATED_AT) values ('D-7470','Thineth Geevinda','200421667662',to_date('17-NOV-04','DD-MON-RR'),'Male','A+',78,'MoreThan4','None','Kalutara','Panideniya','0787877376','bhanuka-0768477376','Thinethgeewinda@gmail.com','$2y$10$oEVBCY2uKdl59S.nv.Jk9.9jBESvdl/a6DHMaWSUJv1FvmRo0pcuC',to_timestamp('06-SEP-26 08.09.53.459000000 PM','DD-MON-RR HH.MI.SSXFF AM'));
...
REM INSERTING into SYSTEM.HOSPITALS
SET DEFINE OFF;
Insert into SYSTEM.HOSPITALS (HOSPITAL_ID,HOSPITAL_NAME,EMAIL,PHONE,ADDRESS,PASSWORD,STATUS,CREATED_AT) values (1,'Asiri','asiri@gmail.com','0112345656','Colombo5','$2y$10$uAzNxqqzZthZX2d4urcls.DsJ6qcKEwL6XtNDF6g5z3lKXKkUAmwm','Approved',to_timestamp('06-SEP-26 08.27.42.092000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.HOSPITALS (HOSPITAL_ID,HOSPITAL_NAME,EMAIL,PHONE,ADDRESS,PASSWORD,STATUS,CREATED_AT) values (21,'Apeksha Maharagama','apekshamaharagama@gmail.com','0112890856','Maharagama A/33','$2y$10$r9jHFIpYf7enPmlZXbxEH.CwvwFVTxlAq8MWqSU9T.ih2ltJYudbS','Approved',to_timestamp('06-SEP-26 08.17.03.099000000 PM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.HOSPITALS (HOSPITAL_ID,HOSPITAL_NAME,EMAIL,PHONE,ADDRESS,PASSWORD,STATUS,CREATED_AT) values (41,'Matara General Hospital','matarageneralhospital@gmail.com','0118999956','Matara','$2y$10$TvIjo94l83IMmVqJ3uKoAO/wKjwogvDYCIti/sVMO8A8zzKClsrqK','Pending',to_timestamp('07-SEP-26 09.24.55.139000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
REM INSERTING into SYSTEM.HOSPITAL_REQUESTS
SET DEFINE OFF;
Insert into SYSTEM.HOSPITAL_REQUESTS (REQUEST_ID,HOSPITAL_NAME,BLOOD_GROUP,UNITS,STATUS,CREATED_AT) values (61,'Asiri','B-',67,'Pending',to_timestamp('07-SEP-26 09.25.21.998000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MARKS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.STAFF_ASSIGNMENTS
SET DEFINE OFF;
Insert into SYSTEM.STAFF_ASSIGNMENTS (STAFF_ID,STAFF_NAME,ROLE,ASSIGNED_CAMP,SHIFT_TIME,CONTACT_NUMBER,STATUS) values (41,'Kamal Perera','Meical Officer (MO)','Trincomalee Harbor Blood Drive','9.00 AM - 5.00  PM',null,'Active');
REM INSERTING into SYSTEM.STUDENT
SET DEFINE OFF;
Insert into SYSTEM.STUDENT (STUID,STUNAME,ADDRESS,BIRTHDAY,AGE) values (1,'Bhanuka','Matara',to_date('04-AUG-03','DD-MON-RR'),45);
Insert into SYSTEM.STUDENT (STUID,STUNAME,ADDRESS,BIRTHDAY,AGE) values (4,'Danushkantha','Dondra',to_date('26-JUL-02','DD-MON-RR'),34);
Insert into SYSTEM.STUDENT (STUID,STUNAME,ADDRESS,BIRTHDAY,AGE) values (2,'Amri','Matara',to_date('03-AUG-03','DD-MON-RR'),33);
Insert into SYSTEM.STUDENT (STUID,STUNAME,ADDRESS,BIRTHDAY,AGE) values (3,'Gayantha','Matara',to_date('26-JUL-02','DD-MON-RR'),34);
REM INSERTING into SYSTEM.STUDENT_MARKS
SET DEFINE OFF;
Insert into SYSTEM.STUDENT_MARKS (MID,STUID,SMARKS,SUBJECT) values (1,1,78,'GUI');
Insert into SYSTEM.STUDENT_MARKS (MID,STUID,SMARKS,SUBJECT) values (2,2,85,'SE');
Insert into SYSTEM.STUDENT_MARKS (MID,STUID,SMARKS,SUBJECT) values (3,3,33,'OOP');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."CHECK_AGE" 
AFTER DELETE
ON STUDENT
...
ALTER TRIGGER "SYSTEM"."CHECK_AGE" ENABLE
--------------------------------------------------------
--  DDL for Trigger DELETE_STUDENT
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."DELETE_STUDENT" 
AFTER DELETE
ON STUDENT
...
ALTER TRIGGER "SYSTEM"."DELETE_STUDENT" ENABLE
--------------------------------------------------------
--  DDL for Trigger LIB_INSERT_MSG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."LIB_INSERT_MSG" 
AFTER INSERT
ON STUDENT
BEGIN
...
ALTER TRIGGER "SYSTEM"."LIB_INSERT_MSG" ENABLE
--------------------------------------------------------
--  DDL for Trigger TRG_AFTER_DONATION
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TRG_AFTER_DONATION" 
AFTER INSERT ON Donations
FOR EACH ROW
DECLARE
    v_blood_group VARCHAR2(5);
BEGIN
    SELECT blood_group INTO v_blood_group FROM Donors WHERE donor_id = :NEW.donor_id;

    UPDATE Donors 
    SET total_donations = total_donations + 1, last_donated_date = :NEW.donation_date 
    WHERE donor_id = :NEW.donor_id;

    UPDATE Blood_Inventory
    SET total_units = total_units + 1, last_updated = SYSDATE
    WHERE blood_group = v_blood_group;
END;

ALTER TRIGGER "SYSTEM"."TRG_AFTER_DONATION" ENABLE
--------------------------------------------------------
--  DDL for Trigger TRG_CHECK_INVENTORY_LEVEL
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TRG_CHECK_INVENTORY_LEVEL" 
BEFORE UPDATE ON blood_inventory
FOR EACH ROW
BEGIN
    IF :NEW.total_units < 10 THEN
        :NEW.status := 'Critical Low';
    ELSE
        :NEW.status := 'Healthy Stock';
    END IF;
END;

ALTER TRIGGER "SYSTEM"."TRG_CHECK_INVENTORY_LEVEL" ENABLE
--------------------------------------------------------
--  DDL for Procedure BOOK_CAMP_SLOT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."BOOK_CAMP_SLOT" (
    p_donor_id IN VARCHAR2, 
    p_camp_id IN VARCHAR2, 
    p_time_slot IN VARCHAR2,
    p_pass_code IN VARCHAR2
) IS
    v_booking_id VARCHAR2(20);
BEGIN
    v_booking_id := 'B-' || TO_CHAR(SYSDATE, 'YYYYMMDDHH24MI');

    INSERT INTO Camp_Bookings (booking_id, donor_id, camp_id, time_slot, pass_code, booking_date, status)
    VALUES (v_booking_id, p_donor_id, p_camp_id, p_time_slot, p_pass_code, SYSDATE, 'Confirmed');

    DBMS_OUTPUT.PUT_LINE('Success: Slot Booked. Pass Code: ' || p_pass_code);
    COMMIT;
END;
--------------------------------------------------------
--  DDL for Procedure DISPLAY_MESSAGE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DISPLAY_MESSAGE" 
...
END;
--------------------------------------------------------
--  DDL for Procedure GET_SQUARE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."GET_SQUARE" 
(
    p_num IN NUMBER,
    p_result OUT NUMBER
)
...
END;
--------------------------------------------------------
--  DDL for Procedure GRT_SQUARE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."GRT_SQUARE" 
(
    p_num IN NUMBER,
    p_result OUT NUMBER
)
...
END;
--------------------------------------------------------
--  DDL for Procedure INCREASE_NUMBER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INCREASE_NUMBER" 
(
    p_num IN OUT NUMBER
)
IS
BEGIN
    -- Fixed: use the actual parameter name 'p_num' instead of 'p_result'
    p_num := p_num + 10;    
END;
--------------------------------------------------------
--  DDL for Procedure INCREASE_NUMER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INCREASE_NUMER" 
(
    p_num IN OUT NUMBER
)
...
END;
--------------------------------------------------------
--  DDL for Procedure REGISTER_NEW_DONOR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."REGISTER_NEW_DONOR" (
...
BEGIN
    -- D-XXXX විදිහට අලුත් ID එකක් හැදීම 
    v_donor_id := 'D-' || TO_CHAR(TRUNC(DBMS_RANDOM.VALUE(1000, 9999)));

    -- Table එකට දත්ත ඇතුලත් කිරීම
    INSERT INTO Donors (
        donor_id, full_name, nic, dob, gender, blood_group, weight, 
        last_donation, health_conditions, district, city, 
        contact_no, emergency_contact, email, user_password
    )
    VALUES (
        v_donor_id, p_full_name, p_nic, p_dob, p_gender, p_blood_group, p_weight, 
        p_last_donation, p_conditions, p_district, p_city, 
        p_contact, p_emergency, p_email, p_password
    );
...
END;
--------------------------------------------------------
--  DDL for Procedure REP_BLOOD_COLLECTION_SUMMARY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."REP_BLOOD_COLLECTION_SUMMARY" AS
BEGIN
    DBMS_OUTPUT.PUT_LINE('----------------------------------------');
    DBMS_OUTPUT.PUT_LINE('   CENTRAL BLOOD INVENTORY REPORT       ');
    DBMS_OUTPUT.PUT_LINE('----------------------------------------');
    FOR r IN (SELECT blood_group, total_units, status FROM blood_inventory) LOOP
        DBMS_OUTPUT.PUT_LINE('Blood Group: ' || RPAD(r.blood_group, 5) || 
                             ' | Units: ' || RPAD(TO_CHAR(r.total_units), 5) || 
                             ' | Status: ' || r.status);
    END LOOP;
    DBMS_OUTPUT.PUT_LINE('----------------------------------------');
END;
--------------------------------------------------------
--  DDL for Procedure REP_DONOR_ELIGIBILITY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."REP_DONOR_ELIGIBILITY" AS
BEGIN
    DBMS_OUTPUT.PUT_LINE('--- ELIGIBLE DONORS REPORT ---');
    FOR r IN (SELECT donor_id, full_name, blood_group FROM donors WHERE weight >= 50 AND last_donation = 'MoreThan4') LOOP
        DBMS_OUTPUT.PUT_LINE('Donor: ' || r.full_name || ' | Group: ' || r.blood_group || ' - ELIGIBLE FOR DONATION');
    END LOOP;
END;
--------------------------------------------------------
--  DDL for Procedure SHOW_STUDENT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."SHOW_STUDENT" 
(
    p_name IN VARCHAR2
)
...
END;
--------------------------------------------------------
--  DDL for Procedure SP_PROCESS_HOSPITAL_REQUEST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."SP_PROCESS_HOSPITAL_REQUEST" (
...
BEGIN
    ...
    SELECT total_units INTO v_current_stock 
    ...
    INSERT INTO hospital_requests (request_id, hospital_name, blood_group, units_requested, urgency_level, request_status)
    VALUES (p_req_id, p_hospital, p_group, p_units, p_urgency, 'Approved');
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Request ' || p_req_id || ' approved successfully. Inventory updated.');

EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('Error: Blood group ' || p_group || ' not found in inventory.');
    WHEN insufficient_stock THEN
        DBMS_OUTPUT.PUT_LINE('Error: Insufficient stock for blood group ' || p_group || '. Available: ' || v_current_stock);
    WHEN OTHERS THEN
        ROLLBACK;
        DBMS_OUTPUT.PUT_LINE('Unexpected error: ' || SQLERRM);
END;
--------------------------------------------------------
--  DDL for Function ADD_NUMBERS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."ADD_NUMBERS" 
(
   a NUMBER,
   b NUMBER
)
...
END;
--------------------------------------------------------
--  DDL for Function FN_GET_TOTAL_BLOOD
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_GET_TOTAL_BLOOD" (p_group VARCHAR2) RETURN NUMBER IS
    v_total NUMBER;
BEGIN
    SELECT NVL(SUM(total_units), 0) INTO v_total FROM blood_inventory WHERE blood_group = p_group;
    RETURN v_total;
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RETURN 0;
END;
--------------------------------------------------------
--  DDL for Function GET_DONOR_ELIGIBILITY_FUNC
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."GET_DONOR_ELIGIBILITY_FUNC" (p_nic IN VARCHAR2) 
RETURN VARCHAR2 AS
    v_name donors.full_name%TYPE;
    v_weight donors.weight%TYPE;
    v_last donors.last_donation%TYPE;
    v_eligibility VARCHAR2(200);
BEGIN
    SELECT full_name, weight, last_donation 
    INTO v_name, v_weight, v_last 
    FROM donors 
    WHERE nic = p_nic;

    IF v_weight >= 50 AND (v_last = 'Never' OR v_last = 'MoreThan4') THEN
        v_eligibility := 'Donor ' || v_name || ' (NIC: ' || p_nic || ') is ELIGIBLE to donate blood.';
    ELSE
        v_eligibility := 'Donor ' || v_name || ' (NIC: ' || p_nic || ') is NOT ELIGIBLE at this moment.';
    END IF;
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RETURN 'Error: No donor found with the given NIC: ' || p_nic;
    WHEN OTHERS THEN
        RETURN 'Error occurred: ' || SQLERRM;
END;
--------------------------------------------------------
--  DDL for Function GET_NEXT_ELIGIBLE_DATE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."GET_NEXT_ELIGIBLE_DATE" (p_donor_id IN VARCHAR2) 
RETURN DATE IS
    v_last_date DATE;
BEGIN
    SELECT last_donated_date INTO v_last_date FROM Donors WHERE donor_id = p_donor_id;
    RETURN ADD_MONTHS(v_last_date, 4);
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RETURN SYSDATE;
END;
--------------------------------------------------------
--  DDL for Function GET_STUDENT_NAME
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."GET_STUDENT_NAME" (p_id NUMBER) 
RETURN VARCHAR2 
IS
    v_name STUDENT.stuname%TYPE;
BEGIN
    SELECT stuname INTO v_name FROM STUDENT WHERE stuid = p_id;
    RETURN v_name;
EXCEPTION
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BLOOD_STOCK" MODIFY ("TOTAL_UNITS" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."BLOOD_STOCK" ADD PRIMARY KEY ("BLOOD_GROUP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."STAFF_ASSIGNMENTS" MODIFY ("STAFF_ID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STAFF_ASSIGNMENTS" MODIFY ("STAFF_NAME" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STAFF_ASSIGNMENTS" MODIFY ("ROLE" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STAFF_ASSIGNMENTS" MODIFY ("ASSIGNED_CAMP" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STAFF_ASSIGNMENTS" MODIFY ("SHIFT_TIME" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STAFF_ASSIGNMENTS" ADD PRIMARY KEY ("STAFF_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HOSPITAL_REQUESTS" MODIFY ("REQUEST_ID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITAL_REQUESTS" MODIFY ("HOSPITAL_NAME" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITAL_REQUESTS" MODIFY ("BLOOD_GROUP" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITAL_REQUESTS" MODIFY ("UNITS" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITAL_REQUESTS" ADD PRIMARY KEY ("REQUEST_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE
--------------------------------------------------------
--  Constraints for Table CAMP_APPOINTMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CAMP_APPOINTMENTS" MODIFY ("APPOINTMENT_ID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."CAMP_APPOINTMENTS" MODIFY ("TIME_SLOT" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."CAMP_APPOINTMENTS" MODIFY ("PASS_CODE" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."CAMP_APPOINTMENTS" ADD PRIMARY KEY ("APPOINTMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."CAMP_APPOINTMENTS" ADD UNIQUE ("PASS_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("STUID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("STUNAME" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("ADDRESS" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("BIRTHDAY" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STUDENT" ADD PRIMARY KEY ("STUID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("FULL_NAME" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("NIC" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("DOB" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("GENDER" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("BLOOD_GROUP" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("WEIGHT" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("LAST_DONATION" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("DISTRICT" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("CITY" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("CONTACT_NO" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("EMERGENCY_CONTACT" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("EMAIL" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" MODIFY ("USER_PASSWORD" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."DONORS" ADD PRIMARY KEY ("DONOR_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."DONORS" ADD UNIQUE ("NIC")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."DONORS" ADD UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CAMPS" MODIFY ("CAMP_ID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."CAMPS" MODIFY ("CAMP_NAME" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."CAMPS" MODIFY ("VENUE" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."CAMPS" ADD PRIMARY KEY ("CAMP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DONATIONS" ADD PRIMARY KEY ("DONATION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."STUDENT_MARKS" MODIFY ("MID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STUDENT_MARKS" MODIFY ("STUID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STUDENT_MARKS" MODIFY ("SMARKS" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."STUDENT_MARKS" MODIFY ("SUBJECT" NOT NULL ENABLE)
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MARKS" MODIFY ("MID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."MARKS" MODIFY ("STUID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."MARKS" MODIFY ("MARKS" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."MARKS" MODIFY ("SUBJECT" NOT NULL ENABLE)
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CAMP_BOOKINGS" ADD PRIMARY KEY ("BOOKING_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BLOOD_INVENTORY" ADD PRIMARY KEY ("BLOOD_GROUP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HOSPITALS" MODIFY ("HOSPITAL_ID" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITALS" MODIFY ("HOSPITAL_NAME" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITALS" MODIFY ("EMAIL" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITALS" MODIFY ("PASSWORD" NOT NULL ENABLE)
  ALTER TABLE "SYSTEM"."HOSPITALS" ADD PRIMARY KEY ("HOSPITAL_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."HOSPITALS" ADD UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
--------------------------------------------------------
--  Ref Constraints for Table CAMP_APPOINTMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CAMP_APPOINTMENTS" ADD FOREIGN KEY ("CAMP_ID")
	  REFERENCES "SYSTEM"."CAMPS" ("CAMP_ID") ENABLE
--------------------------------------------------------
